...
import am.a_t.mobilemarcet.databinding.FragmentSmartphonesProductsBinding
...
class SmartphonesProductsFragment : Fragment() {
    private lateinit var binding: FragmentSmartphonesProductsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSmartphonesProductsBinding.inflate(inflater, container, false)
    ...
    private fun initViewModel() {
        ...
        lifecycleScope.launch {
            viewModel.samsungLiveData.collectLatest {
